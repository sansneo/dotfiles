...
alias azure-cli="docker run --rm -it -v /home/\$(whoami)/.azure:/root/.azure -v \$(pwd):/data mcr.microsoft.com/azure-cli"
alias tencent-cli="docker run --rm -it -v /home/\$(whoami)/.tencent:/root/.tencent -v \$(pwd):/data tencentcloud/tencentcloud-cli"
